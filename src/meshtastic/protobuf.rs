        ...
        match field_number {
            ...
            user_fields::HW_MODEL if wire_type == WIRE_TYPE_VARINT => {
                result.hw_model = match decoder.read_varint()? as u16 {
                    ...
                    25 => HardwareModel::EbyteEsp32S3,
                    26 => HardwareModel::Esp32S3Pico,
                    27 => HardwareModel::Chatter2,
                    28 => HardwareModel::HeltecWirelessPaperV1_0,
                    29 => HardwareModel::HeltecWirelessTrackerV1_0,
                    30 => HardwareModel::Unphone,
                    31 => HardwareModel::Tdeck,
                    32 => HardwareModel::TWatchS3,
                    33 => HardwareModel::PicomputerS3,
                    34 => HardwareModel::HeltecWifiLoraV3,
                    35 => HardwareModel::HeltecWifiLoraV4,
                    36 => HardwareModel::Genieblocks,
                    37 => HardwareModel::Nrf52Unknown,
                    38 => HardwareModel::Portduino,
                    39 => HardwareModel::AndroidSim,
                    40 => HardwareModel::DiyV1,
