...
pub enum PortNum {
    ...
    NodeStatusApp = 36,
    // mesh.proto aliases: SERIAL_APP, STORE_FORWARD_APP, RANGE_TEST_APP,
    // TELEMETRY_APP, ZPS_APP, SIMULATOR_APP, TRACEROUTE_APP,
    // NEIGHBORINFO_APP, ATAK_PLUGIN
    Serial = 64,
    StoreForward = 65,
    RangeTest = 66,
    Telemetry = 67,
...
impl From<u32> for PortNum {
    fn from(v: u32) -> Self {
        match v {
            ...
            11 => PortNum::AlertApp,
            12 => PortNum::KeyVerificationApp,
            32 => PortNum::Reply,
            33 => PortNum::IpTunnelApp,
            34 => PortNum::Paxcounter,
            35 => PortNum::StoreForwardPlusPlusApp,
            36 => PortNum::NodeStatusApp,
            64 => PortNum::Serial,
            ...
            72 => PortNum::Atak,
            73 => PortNum::MapReportApp,
            74 => PortNum::PowerStressApp,
            75 => PortNum::LoraWanBridge,
            76 => PortNum::ReticulumTunnelApp,
            77 => PortNum::CayenneApp,
            112 => PortNum::GroupAlarmApp,
            256 => PortNum::Private,
...
pub enum HardwareModel {
    ...
    Betafpv900NanoTx = 47,
    RpiPico = 48,
    HeltecWirelessTracker = 49,
    HeltecWirelessPaper = 50,
    Tdeck = 51,
    Esp32S3Pico = 56,
    Chatter2 = 57,
    HeltecWirelessPaperV1_0 = 58,
    TdLoraC = 61,
    CdeByteEoraS3 = 62,
    TwcMeshV4 = 63,
    Nrf52PromicroDiy = 64,
    RadioMaster900BanditNano = 65,
    HeltecCapsuleSensorV3 = 66,
    HeltecVisionMasterT190 = 67,
    HeltecVisionMasterE213 = 68,
    HeltecVisionMasterE290 = 69,
    HeltecMeshNodeT114 = 70,
    SensecapIndicator = 71,
    TrackerT1000E = 72,
    Rak3172 = 73,
    WioE5 = 74,
    RadioMaster900Bandit = 75,
    Me25Ls014y10Td = 76,
    Rp2040FeatherRfm95 = 77,
    M5StackCoreBasic = 78,
    M5StackCore2 = 79,
    RpiPico2 = 80,
    M5StackCoreS3 = 81,
